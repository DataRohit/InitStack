...
class TestHealthCheckView:
    ...
    # Patch Metrics Decorator
    def _patch_metrics(self) -> tuple[MagicMock, MagicMock, MagicMock]:
        """
        Patch Metrics Objects.

        Returns:
            tuple[MagicMock, MagicMock, MagicMock]: Patches For Requests, Errors, Duration.
        """

        # Build Mocks
        requests_total: MagicMock = MagicMock()
        errors_total: MagicMock = MagicMock()
        duration_ms: MagicMock = MagicMock()

        # Return Tuple
        return requests_total, errors_total, duration_ms

    # Test Healthy Response
    def test_health_view_healthy(self) -> None:
        """
    ...
    def test_health_view_degraded(self) -> None:
        """
    ...
    def test_health_view_unhealthy(self) -> None:
        """
    ...
    # Test Psutil Error Path
    def test_health_view_unexpected_error(self) -> None:
        """
    ...
    # Test Psutil Error Explicit
    def test_health_view_psutil_error(self) -> None:
        """

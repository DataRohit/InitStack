...
# Test JWT Authentication Extension Class
class TestJWTAuthenticationExtension:
    ...
    def test_class_attributes(self, jwt_authentication_extension: JWTAuthenticationExtension) -> None:
        """
        Test Class Attributes Are Set Correctly.

        Args:
            jwt_authentication_extension (JWTAuthenticationExtension): JWT Authentication Extension Instance.
        """

        # Assert Target Class Is Set Correctly
        assert (
            jwt_authentication_extension.target_class
            == "apps.common.authentication.jwt_authentication.JWTAuthentication"
        )
    ...
    def test_get_security_definition(
        ...
        Args:
            jwt_authentication_extension (JWTAuthenticationExtension): JWT Authentication Extension Instance.
            mock_auto_schema (MagicMock): Mock Auto Schema Instance.
        """
    ...
    def test_inheritance(self, jwt_authentication_extension: JWTAuthenticationExtension) -> None:
        """

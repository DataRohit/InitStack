...
def test_identifier(elasticsearch_health_check: ElasticsearchHealthCheck) -> None:
    """
...
def test_critical_service_attribute(elasticsearch_health_check: ElasticsearchHealthCheck) -> None:
    """

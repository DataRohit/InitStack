...
# User Me Response Serializer Class
@extend_schema_serializer(
    examples=[
        OpenApiExample(
            name="User Me Response Example",
            value={
                "status_code": 200,
                "user": {
            ...
            summary="User Me Response Example",
            description="User Me Response Example",
            response_only=True,
            status_codes=[status.HTTP_200_OK],
        ),
    ],
)
class UserMeResponseSerializer(GenericResponseSerializer):
    """
    User Me Response Serializer For Standardized API Responses.
...
# User Me Unauthorized Error Response Serializer Class
@extend_schema_serializer(
    examples=[
        OpenApiExample(
...
class UserMeUnauthorizedErrorResponseSerializer(GenericResponseSerializer):
    """
    User Me Unauthorized Error Response Serializer For Standardized API Responses.

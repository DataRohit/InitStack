...
def test_form_validation_with_valid_data(user_creation_form: UserCreationForm) -> None:
    """
    Test Form Validation With Valid Data.
...
def test_password_mismatch(user_creation_form_data: dict[str, str]) -> None:
    """
...
def test_clean_email_method(user_creation_form: UserCreationForm) -> None:
    """
    Test Clean Email Method.
...
def test_clean_username_method(user_creation_form: UserCreationForm) -> None:
    """
    Test Clean Username Method.
...
def test_clean_first_name_method(user_creation_form: UserCreationForm) -> None:
    """
    Test Clean First Name Method.
...
def test_clean_last_name_method(user_creation_form: UserCreationForm) -> None:
    """
    Test Clean Last Name Method.
...
def test_form_with_whitespace_in_fields(user_creation_form_data: dict[str, str]) -> None:
    """
    Test Form With Whitespace In Fields.
...
def test_form_with_multi_word_names(user_creation_form_data: dict[str, str]) -> None:
    """
...
def test_duplicate_email_validation(user_instance: User, user_creation_form_data: dict[str, str]) -> None:
    """
    Test Duplicate Email Validation.
...
def test_duplicate_username_validation(user_instance: User, user_creation_form_data: dict[str, str]) -> None:
    """
    Test Duplicate Username Validation.

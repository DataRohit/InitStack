...
# Local Imports
import apps.users.opentelemetry.views.user_reactivate_request_metrics as urr_metrics
...
# Test Reactivate Request Initiated Recorder
def test_record_reactivate_request_initiated_calls_counter() -> None:
    """
    Verify record_reactivate_request_initiated Adds To Counter With Empty Labels.
    """

...
# Local Imports
import apps.users.opentelemetry.views.user_reactivate_confirm_metrics as urc_metrics
...
# Test Reactivation Performed Recorder
def test_record_reactivation_performed_calls_counter() -> None:
    """
    Verify record_reactivation_performed Adds To Counter With Empty Labels.
    """

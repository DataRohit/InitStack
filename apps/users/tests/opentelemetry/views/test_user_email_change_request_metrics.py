...
# Local Imports
import apps.users.opentelemetry.views.user_email_change_request_metrics as uecr_metrics
...
# Test Email Change Request Initiated Recorder
def test_record_email_change_request_initiated_calls_counter() -> None:
    """
    Verify record_email_change_request_initiated Adds To Counter With Empty Labels.
    """

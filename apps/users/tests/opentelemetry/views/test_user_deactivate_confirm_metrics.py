...
# Local Imports
import apps.users.opentelemetry.views.user_deactivate_confirm_metrics as udc_metrics
...
# Test Deactivation Performed Recorder
def test_record_deactivation_performed_calls_counter() -> None:
    """
    Verify record_deactivation_performed Adds To Counter With Empty Labels.
    """
    ...
    with patch.object(
        ...
        # Type Hint
        deact_total: MagicMock

        # Call Function
        record_deactivation_performed()

    # Assert Call
    deact_total.add.assert_called_once_with(1, {})
